...
<div class="fieldGroup" id="fieldGroup">
    ...
    <div class="form-group row required">
        ...
        <div class="col-4 form-group">
            {{ Form::text('BeginDate', ($user->exists && isset($user->finalEducation)) ? $user->finalEducation->BeginDate->format('Y-m-d') : old('BeginDate'), ['class' => ($errors->has('BeginDate')) ? 'form-control is-invalid' :'form-control', '',"data-required-error"=>'Bu sahəni boş buraxmayın','id'=> 'BeginDate']) }}
        ...
        <div class="col-4 form-group">
            {{ Form::text('EndDate', ($user->exists && isset($user->finalEducation)) ? $user->finalEducation->EndDate->format('Y-m-d') : old('EndDate'), ['class' => ($errors->has('EndDate')) ? 'form-control is-invalid' :'form-control', '',"data-required-error"=>'Bu sahəni boş buraxmayın','id'=> 'EndDate']) }}
    ...
    <div class="form-group row required">
        ...
        <div class="col-8">
            {{ Form::number('admission_score',
                ($user->exists && isset($user->finalEducation)) ? $user->finalEducation->AdmissionScore : old('admission_score'),
             ['class' => 'form-control', 'step' => '0.1', '',"data-required-error"=>'Qəbul balı sahəsini düzgün qeyd edin',"data-error"=>'Qəbul balı maksimum 700-dən yuxarı olmamamalıdır','maxlength'=>3,'max'=>"700", 'id' => 'admission_score',
             ]) }}
            @if ($errors->has('admission_score'))
                <div class="invalid-feedback">
                    <strong>{{ $errors->first('admission_score') }}</strong>
