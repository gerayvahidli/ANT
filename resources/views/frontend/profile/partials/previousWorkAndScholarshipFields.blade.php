    ...
    @foreach($user->previousJobs as $previousJob)
        <div class="workFieldGroup" id="workFieldGroup">
            ...
            <div class="form-group row ">
                ...
                <div class="col-8">
                    <input value="{{  $user -> exists && isset($previousJob -> Organization) ? $previousJob -> Organization : null }}" class="form-control" type="text" name="previous_organization[]" id="previous_organization">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            <div class="form-group row required ">
                ...
                <div class="col-8">
                    <input value="{{  $user -> exists  ? $previousJob -> Department : null }}" class="form-control" type="text" name="previous_department[]" id="">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            ...
            <div class="form-group row required">
                ...
                <div class="col-8">
                    <input value="{{  $user -> exists  ? $previousJob -> Position : null }}" class="form-control" type="text" name="previous_position[]" id="previous_position">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            ...
            <div class="form-group row required">
                ...
                <div class="col-8">
                    <input value="{{  $user -> exists  ? $previousJob -> StartDate : null }}" class="form-control" type="date" name="previous_StartDate[]" id="previous_StartDate">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
            ...
            <div class="form-group row required">
                ...
                <div class="col-8">
                    <input value="{{  $user -> exists  ? $previousJob -> EndDate : null }}" class="form-control" type="date" name="previous_EndDate[]" id="previous_EndDate">
                    <div class="help-block with-errors"></div>
                </div>
            </div>
