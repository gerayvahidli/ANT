            ...
            <div class="col-12 col-sm-5 right-dotted-line">
                ...
                <div class="form-group row required">
                    ...
                    <div class="col-8">
                        <input id="idCardNumber" name="idCardNumber"
                               ...
                               data-required-error='Şəxsiyyət vəsiqəsinin nömrəsi sahəsini boş buraxmayın' minlength="8"
                               pattern="\d*" data-pattern-error="Yalnız rəqəm daxil edin"
                               data-error='Şəxsiyyət vəsiqəsinin nömrəsi sahəsi minimum 8 simvoldan ibarət olmalidir'
                        >
                ...
                <div class="form-group row required">
                    ...
                    <div class="col-8">
                        ...
                        @endif
                        <div class="help-block with-errors" id="idCardPinErrorText"></div>
                    </div>
                </div>
                <div class="form-group row required">
            ...
            $('#profile-form').submit(function (stay) {
                ...
                window.location.href = '{{ route('profile.index') }}';
                    ...
                    $.each(error.response.data.errors, function (key, value) {
                        ...
                        console.log($("input[name='" + key + "']").closest('.form-group ').find('invalid-feedback'));
        ...
        $(document).ready(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (countryId != 5) {
                                ...
                                // $('#admission_score').removeAttr('data-required-error');
            ...
            $("#addMoreInternship").click(function () {
                if ($('body').find('.previousInternshipFieldGroup').length < maxGroup) {
                    ...
                    $('body').find('.previousInternshipFieldGroup:last').before(fieldHTML);
                } else {
            ...
            $("#addMoreScholarship").click(function () {
                if ($('body').find('.previousScholarshipFieldGroup').length < maxGroup) {
                    ...
                    $('body').find('.previousScholarshipFieldGroup:last').before(fieldHTML);
                } else {
