...
//			'password'                             => 'required|string|min:6|confirmed',
			...
			'City_id'                              => 'required',
			'customCity'                           => 'required_if:City_id,52|nullable|string',
			'Address'                              => 'required|string',
			'idCardNumber'                         => 'required|string|min:6',
			'idCardPin'                            => 'required|string|size:7',
			'MaidenSurname'                        => 'required|string',
			//final education
			'education_level'                      => 'required',
			'country_id'                           => 'required|integer',
			'university_id'                        => 'required|integer',
			'BeginDate'                            => 'required|integer',
			'EndDate'                              => 'required|integer',
			'current_edu_year'                     => 'required|integer',
			'faculty'                              => 'required|string',
			'speciality'                           => 'required|string',
			'admission_score'                      => 'float|between:0,100|nullable',
			'education_section_id'                 => 'sometimes|integer',
			'education_section'                    => 'required_if:education_section_id,4|nullable|string',
			...
			'previous_education_admission_score.*' => 'float|between:0,100|nullable',
			// work
			'is_currently_working'                 => 'required|boolean',
			'is_currently_working_at_socar'        => 'sometimes|boolean|nullable',
	...
	protected function create ( array $data )
	{
		...
		$user->country_id = $data[ 'nationality' ];;
		$user->Address                 = $data[ 'Address' ];
		$user->IdentityCardNumber      = $data[ 'idCardNumber' ];
		$user->IdentityCardCode        = $data[ 'idCardPin' ];
